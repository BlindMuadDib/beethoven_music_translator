...
describe('findCurrentLineIndex', () => {
    const mockLines = [
        { line_text: 'Line 1', line_start_time: 1, line_end_time: 2 },
    ...
    // Ensure lyrics don't show prematurely
    test('should return -1 when time is before the very first line', () => {
        expect(findCurrentLineIndex(0.5, mockLines)).toBe(-1);
    });
});
