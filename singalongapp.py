...
from singalongapp.maptranscript import process_transcript, create_alignment_dict, sync_alignment_dict_with_transcript_lines, calculate_midpoints
...
def singalongapp():
    ...
    if alignment_path:
        ...
        if alignment_dict:
            ...
            midpoints = calculate_midpoints(synchronized_transcript)
            display_lyrics(audio_path, synchronized_transcript, midpoints)
    else:
